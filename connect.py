...
def main():
    ...
    #"""<API_KEY>"""  # Replace with your actual key. if you don't have one, get from Azure or from Community https://curious.pm
        ...
        if azure_openai_key and azure_openai_endpoint:
            try:
                ...
                if uploaded_file != None:
                    extension = uploaded_file.name()
                    st.title(f"Extension: {extension}")
        else:
